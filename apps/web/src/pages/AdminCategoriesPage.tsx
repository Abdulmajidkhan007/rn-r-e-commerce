...
export default function AdminCategoriesPage(): React.ReactElement {
  ...
  return (
    <Stack spacing={2}>
      ...
      {categories.length === 0 ? (
        <Typography color="text.secondary">{t('admin.noCategories')}</Typography>
      ) : (
        <Table size="small">
          <TableHead>
            <TableRow>
              ...
              <TableCell align="right">{t('admin.order')}</TableCell>
              <TableCell align="right">{t('admin.products')}</TableCell>
